    ...
    <main className="app-shell">
      <section className="calculator-card">
        ...
        <div className="button-row">
          <button className="green" type="button" onClick={() => handleOperation(sum)}>
            Sumar
          </button>
          <button className="red" type="button" onClick={() => handleOperation(subtract)}>
            Restar
          </button>
          <button className="blue" type="button" onClick={() => handleOperation(multiply)}>
            Multiplicar
          </button>
          <button className="orange" type="button" onClick={() => handleOperation(divide)}>
            Dividir
          </button>
        </div>
